...
<img src="https://latex.codecogs.com/gif.latex?Y_{lm}=\begin{cases}\displaystyleY_{lm}(\theta,\phi)=(-1)^m\sqrt{2}\sqrt{\frac{2l+1}{4\pi}\frac{(l-|m|)!}{(l+|m|)!}}P_l^{|m|}(cos\theta)cos(|m|\phi)\\\displaystyle\\\displaystyle\end{cases}" /> 
