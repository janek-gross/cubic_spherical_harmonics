...
Note that in some of the formulas the sign deviates from the ones lised on <a href=https://en.wikipedia.org/wiki/Table_of_spherical_harmonics#Real_spherical_harmonics>Wikipedia</a>.
